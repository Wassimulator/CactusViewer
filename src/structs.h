...
struct Shader_Constants_Paint {
    v2    point_a;      // Previous mouse position in pixels.
    v2    point_b;      // Current mouse position in pixels.
    v4    color;        // Brush color (rgb) and base alpha in .a.
...
struct Graphics
{
    ...
    ID3D11ShaderResourceView  *paint_canvas_srv;
    ID3D11UnorderedAccessView *paint_canvas_uav;
    ID3D11ShaderResourceView  *paint_canvas_preview_srv;
    ID3D11UnorderedAccessView *paint_canvas_preview_uav;
